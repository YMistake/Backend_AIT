...
module.exports = function(passport) {
    ...
    passport.use(
        ...
        new LocalStrategy({
            ...
            usernameField : 'req.body.user',
            passwordField : 'req.body.pass',
            firstnameField : 'req.body.first',
            lastnameField : 'req.body.last',
            emailField : 'req.body.email',
            roleField : 'req.body.role',
        ...
        function(req, done) {
            ...
            connection.query("SELECT * FROM startup WHERE Username = ?",[req.body.user], function(err, rows) {
                ...
                if (rows.length) {
                    ...
                    var insertQuery = "INSERT INTO startup set ?";

                    connection.query(insertQuery,newUserMysql,function(err, results) {
